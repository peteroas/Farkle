defmodule FarkleWeb.GameControllerTest do
  use FarkleWeb.ConnCase

  alias Farkle.Games

  @create_attrs %{code: "some code", punishment: "some punishment", winning_score: 42}
  @update_attrs %{code: "some updated code", punishment: "some updated punishment", winning_score: 43}
  @invalid_attrs %{code: nil, punishment: nil, winning_score: nil}
